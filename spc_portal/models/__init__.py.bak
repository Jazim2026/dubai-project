...
from . import spc_company_management
from . import spc_company_application
...
from . import spc_reentry_permit
from . import spc_lease_document
from . import spc_medical
from . import spc_meeting_room
from . import spc_mofa
from . import spc_banking_assistance

from . import spc_vip_medical

from . import spc_driving_license

from . import spc_phone_answering
